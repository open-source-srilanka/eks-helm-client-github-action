...
# Generate changelog
{
  ...
  echo "  uses: $REPOSITORY@v$VERSION"
  echo "  with:"
  ...
  echo "### 📚 Documentation"
  echo ""
  echo "- [README](https://github.com/$REPOSITORY/blob/v$VERSION/README.md)"
  echo "- [Migration Guide](https://github.com/$REPOSITORY/blob/v$VERSION/docs/MIGRATION.md)"
  echo "- [Examples](https://github.com/$REPOSITORY/tree/v$VERSION/docs/examples)"
  echo ""
  echo "---"
  echo ""
  echo "**Full Changelog**: https://github.com/$REPOSITORY/compare/$LAST_TAG...v$VERSION"
} > changelog.md
